...
Still externally gated or incomplete: CockroachDB Cloud TLS/managed backup/restore and Managed MCP evidence, live Guardrail intervention, AWS deployment/hosted rehearsals, browser accessibility/E2E evidence, live PRAVA, and advanced AgentCore/Automated Reasoning/changefeed/multi-region experiments. A five-case labelled live Nova qualification gate now passes at 100%; the disposable local restore drill passes but neither substitutes for hosted evidence.
