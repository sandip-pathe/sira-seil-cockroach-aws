...
const operations = {
  ...
  qualification_create_company_context: { method: "POST", path: "/v1/qualification/company-context", responseMediaType: "application/json" },
  qualification_create_introduction: { method: "POST", path: "/v1/qualification/engagements/{engagement_id}/introduction", responseMediaType: "application/json" },
  qualification_create_mission: { method: "POST", path: "/v1/qualification/missions", responseMediaType: "application/json" },
  qualification_decide_approval: { method: "POST", path: "/v1/qualification/decisions/{decision_id}/approval", responseMediaType: "application/json" },
  qualification_get_company_context: { method: "GET", path: "/v1/qualification/company-context/{item_id}", responseMediaType: "application/json" },
  qualification_get_engagement: { method: "GET", path: "/v1/qualification/engagements/{engagement_id}", responseMediaType: "application/json" },
  qualification_get_integrity: { method: "GET", path: "/v1/qualification/missions/{mission_id}/integrity", responseMediaType: "application/json" },
  qualification_get_mission: { method: "GET", path: "/v1/qualification/missions/{mission_id}", responseMediaType: "application/json" },
  qualification_get_mission_events: { method: "GET", path: "/v1/qualification/missions/{mission_id}/events", responseMediaType: "application/json" },
  qualification_list_company_context: { method: "GET", path: "/v1/qualification/company-context", responseMediaType: "application/json" },
  qualification_record_consent: { method: "POST", path: "/v1/qualification/engagements/{engagement_id}/consents", responseMediaType: "application/json" },
