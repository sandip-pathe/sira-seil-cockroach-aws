...
const operations = {
  ...
  create_exchange_handoff: { method: "POST", path: "/v1/exchange-cases/{case_id}/handoffs", bodyMediaType: "application/json", responseMediaType: "application/json" },
  create_payment_handoff: { method: "POST", path: "/v1/purchase-intents/{intent_id}/payment-handoff", bodyMediaType: null, responseMediaType: "application/json" },
  ...
  get_exchange_case: { method: "GET", path: "/v1/exchange-cases/{case_id}", bodyMediaType: null, responseMediaType: "application/json" },
  ...
  open_exchange_handoff: { method: "POST", path: "/v1/exchange-cases/{case_id}/handoffs/{handoff_id}/open", bodyMediaType: "application/json", responseMediaType: "application/json" },
